...
def test_shortcut_color_by_mutation(test_worker: TestWorker):
    ...
    shortcut_color_by_mutation(obj1=obj_1, obj2=obj_2)
...
@pytest.mark.parametrize(
    "test_name,table_file_name,pos_slice,offset,label_x,label_y,index_x,index_y,palette_code,do_rescale",
    [
        # test formats
        ...
        [
            "CSV-explict-full-length",
            "csv/3fap_hf3_A_short.Backbone.rmsf_res.csv",
            "1-11",
            0,
            None,
            None,
