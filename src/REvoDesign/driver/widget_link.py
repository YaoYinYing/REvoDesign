...
class PushButtons:
    ...
    button_ids: tuple = (
        ...
        "accept_this_mutant",
        "open_mut_table_2",
        "open_cluster_evo_pssm_profile",
        "open_cluster_evo_esm1v_table",
        "open_cluster_evo_structure_pdb",
        "run_cluster",
    ...
    c2wi: immutabledict[str, str] = immutabledict(
        {
            ...
            "ui.cluster.method.use": "comboBox_cluster_method",
            ...
            "ui.cluster.random_seed": "spinBox_cluster_random_seed",
            "ui.cluster.mutate_relax": "checkBox_cluster_mutate_and_relax",
            "ui.cluster.rosetta.override_representatives": "checkBox_cluster_rosetta_override_representatives",
            "ui.cluster.evo.inputs.pssm_profile": "lineEdit_cluster_evo_pssm_profile",
            "ui.cluster.evo.inputs.esm1v_table": "lineEdit_cluster_evo_esm1v_table",
            "ui.cluster.evo.inputs.structure_pdb": "lineEdit_cluster_evo_structure_pdb",
            "ui.cluster.evo.esm.mutation_col": "lineEdit_cluster_evo_esm_mutation_col",
            "ui.cluster.evo.weights.seq": "doubleSpinBox_cluster_evo_weight_seq",
            "ui.cluster.evo.weights.physchem": "doubleSpinBox_cluster_evo_weight_physchem",
            "ui.cluster.evo.weights.spatial": "doubleSpinBox_cluster_evo_weight_spatial",
            "ui.cluster.evo.weights.pssm": "doubleSpinBox_cluster_evo_weight_pssm",
            "ui.cluster.evo.weights.esm": "doubleSpinBox_cluster_evo_weight_esm",
