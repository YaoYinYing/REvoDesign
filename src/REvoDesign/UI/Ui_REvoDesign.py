...
class Ui_REvoDesignPyMOL_UI(object):
    def setupUi(self, REvoDesignPyMOL_UI):
        ...
        self.actionMove_Box = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionMove_Box.setObjectName("actionMove_Box")
        ...
        self.menuSmall_Molecule.addAction(self.actionVina_3)
        self.menuSmall_Molecule.addSeparator()
        ...
        self.menuVina_Tools.addAction(self.actionMove_Box)
        self.menuVina_Tools.addAction(self.actionChange_Box)
    ...
    def retranslateUi(self, REvoDesignPyMOL_UI):
        ...
        self.actionMove_Box.setText(_translate("REvoDesignPyMOL_UI", "Move Box"))
