...
class Ui_REvoDesignPyMOL_UI(object):
    def setupUi(self, REvoDesignPyMOL_UI):
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(220, 290, 61, 61))
        ...
        self.groupBox_cluster_general = QtWidgets.QGroupBox(self.tab_cluster)
        self.groupBox_cluster_general.setGeometry(QtCore.QRect(10, 0, 271, 271))
        self.groupBox_cluster_general.setObjectName("groupBox_cluster_general")
        self.verticalLayoutWidget_cluster_general = QtWidgets.QWidget(self.groupBox_cluster_general)
        self.verticalLayoutWidget_cluster_general.setGeometry(QtCore.QRect(10, 30, 251, 231))
        ...
        self.horizontalLayout_cluster_method.addWidget(self.label_cluster_method)
        ...
        self.horizontalLayout_cluster_method.addWidget(self.comboBox_cluster_method)
        ...
        self.pushButton_run_cluster = QtWidgets.QPushButton(self.verticalLayoutWidget_cluster_general)
        ...
        self.verticalLayout_cluster_general.addLayout(self.horizontalLayout_22)
        self.groupBox_cluster_method_settings = QtWidgets.QGroupBox(self.tab_cluster)
        self.groupBox_cluster_method_settings.setGeometry(QtCore.QRect(290, 0, 371, 361))
        self.groupBox_cluster_method_settings.setObjectName("groupBox_cluster_method_settings")
        self.stackedWidget_cluster_method_settings = QtWidgets.QStackedWidget(self.groupBox_cluster_method_settings)
        self.stackedWidget_cluster_method_settings.setGeometry(QtCore.QRect(10, 20, 331, 331))
        ...
        self.gridLayout_cluster_evo.addLayout(self.horizontalLayout_cluster_evo_pssm, 0, 1, 1, 3)
        ...
        self.gridLayout_cluster_evo.addLayout(self.horizontalLayout_cluster_evo_esm, 1, 1, 1, 3)
        ...
        self.gridLayout_cluster_evo.addLayout(self.horizontalLayout_cluster_evo_structure, 2, 1, 1, 3)
        ...
        self.gridLayout_cluster_evo.addWidget(self.label_cluster_evo_mutation_col, 3, 0, 1, 1)
        ...
        self.gridLayout_cluster_evo.addWidget(self.lineEdit_cluster_evo_esm_mutation_col, 3, 1, 1, 1)
        ...
        self.gridLayout_cluster_evo.addWidget(self.label_cluster_evo_weight_physchem, 4, 2, 1, 1)
        ...
        self.gridLayout_cluster_evo.addWidget(self.doubleSpinBox_cluster_evo_weight_physchem, 4, 3, 1, 1)
        ...
        self.gridLayout_cluster_evo.addWidget(self.label_cluster_evo_weight_pssm, 5, 2, 1, 1)
        ...
        self.gridLayout_cluster_evo.addWidget(self.doubleSpinBox_cluster_evo_weight_pssm, 5, 3, 1, 1)
        ...
        self.groupBox_cluster_post = QtWidgets.QGroupBox(self.tab_cluster)
        self.groupBox_cluster_post.setGeometry(QtCore.QRect(10, 270, 201, 91))
        self.groupBox_cluster_post.setObjectName("groupBox_cluster_post")
        self.verticalLayoutWidget_cluster_post = QtWidgets.QWidget(self.groupBox_cluster_post)
        self.verticalLayoutWidget_cluster_post.setGeometry(QtCore.QRect(10, 20, 181, 61))
        ...
        self.actionRefreshEnvironVar = QtWidgets.QAction(REvoDesignPyMOL_UI)
        ...
        self.actionRenumber_Residue_Index = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionRenumber_Residue_Index.setObjectName("actionRenumber_Residue_Index")
        self.actionDump_Sequence = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionDump_Sequence.setObjectName("actionDump_Sequence")
        self.actionRosettaLigand = QtWidgets.QAction(REvoDesignPyMOL_UI)
        ...
        self.actionSDF_to_Rosetta_Parameters = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionSDF_to_Rosetta_Parameters.setObjectName("actionSDF_to_Rosetta_Parameters")
        self.actionRosetta_Score_Analyser = QtWidgets.QAction(REvoDesignPyMOL_UI)
        ...
        self.actionFastRelax = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionFastRelax.setObjectName("actionFastRelax")
        self.actionRelax_w_Ca_Constraints = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionRelax_w_Ca_Constraints.setObjectName("actionRelax_w_Ca_Constraints")
        self.actionThermoMPNN = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionThermoMPNN.setObjectName("actionThermoMPNN")
        self.actionESM_1v = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionESM_1v.setObjectName("actionESM_1v")
        self.actionStart_SetupOpenMM = QtWidgets.QAction(REvoDesignPyMOL_UI)
        ...
        self.actionVina_3 = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionVina_3.setObjectName("actionVina_3")
        self.actionVina = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionVina.setObjectName("actionVina")
        self.actionVina_Prepare_Ligand = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionVina_Prepare_Ligand.setObjectName("actionVina_Prepare_Ligand")
        self.actionVina_Prepare_Receptor = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionVina_Prepare_Receptor.setObjectName("actionVina_Prepare_Receptor")
        self.actionVina_Export_Results = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionVina_Export_Results.setObjectName("actionVina_Export_Results")
        self.actionGet_Box = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionGet_Box.setObjectName("actionGet_Box")
        self.actionAlter_Box = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionAlter_Box.setObjectName("actionAlter_Box")
        self.actionChange_Box = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionChange_Box.setObjectName("actionChange_Box")
        self.actionGet_PCA_Box = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionGet_PCA_Box.setObjectName("actionGet_PCA_Box")
        self.actionRemove_Het_Atoms = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionRemove_Het_Atoms.setObjectName("actionRemove_Het_Atoms")
        self.actionSubstrate_Potential = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionSubstrate_Potential.setObjectName("actionSubstrate_Potential")
        self.actionRFdiffusion_General_Task = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionRFdiffusion_General_Task.setObjectName("actionRFdiffusion_General_Task")
        self.actionRMSF_to_b_factor = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionRMSF_to_b_factor.setObjectName("actionRMSF_to_b_factor")
        self.actionUtils = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionUtils.setObjectName("actionUtils")
        self.actionMake_Residue_Range = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionMake_Residue_Range.setObjectName("actionMake_Residue_Range")
        self.actionShorten_Range = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionShorten_Range.setObjectName("actionShorten_Range")
        self.actionRun_GREMLIN = QtWidgets.QAction(REvoDesignPyMOL_UI)
        self.actionRun_GREMLIN.setObjectName("actionRun_GREMLIN")
        self.actionFont = QtWidgets.QAction(REvoDesignPyMOL_UI)
    ...
    def retranslateUi(self, REvoDesignPyMOL_UI):
        ...
        self.groupBox_cluster_general.setTitle(_translate("REvoDesignPyMOL_UI", "General clustering inputs"))
        ...
        self.groupBox_cluster_method_settings.setTitle(_translate("REvoDesignPyMOL_UI", "Method-specific settings"))
        ...
        self.label_cluster_evo_pssm.setText(_translate("REvoDesignPyMOL_UI", "PSSM profile"))
        self.pushButton_open_cluster_evo_pssm_profile.setText(_translate("REvoDesignPyMOL_UI", "..."))
        self.label_cluster_evo_esm.setText(_translate("REvoDesignPyMOL_UI", "ESM-1v table"))
        self.pushButton_open_cluster_evo_esm1v_table.setText(_translate("REvoDesignPyMOL_UI", "..."))
        self.label_cluster_evo_structure.setText(_translate("REvoDesignPyMOL_UI", "Structure PDB"))
        ...
        self.label_cluster_evo_weight_seq.setText(_translate("REvoDesignPyMOL_UI", "Sequence weight"))
        self.label_cluster_evo_weight_physchem.setText(_translate("REvoDesignPyMOL_UI", "Physchem weight"))
        self.label_cluster_evo_weight_spatial.setText(_translate("REvoDesignPyMOL_UI", "Spatial weight"))
        self.label_cluster_evo_weight_pssm.setText(_translate("REvoDesignPyMOL_UI", "PSSM weight"))
        self.label_cluster_evo_weight_esm.setText(_translate("REvoDesignPyMOL_UI", "ESM weight"))
        ...
        self.groupBox_cluster_post.setTitle(_translate("REvoDesignPyMOL_UI", "Post-clustering Rosetta scoring"))
