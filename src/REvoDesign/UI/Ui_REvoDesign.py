...
class Ui_REvoDesignPyMOL_UI:
    def setupUi(self, REvoDesignPyMOL_UI):
        ...
        self.checkBox_ws_server_use_key.toggled['bool'].connect(self.lineEdit_ws_server_key.setEnabled)  
    ...
    def retranslateUi(self, REvoDesignPyMOL_UI):
        ...
        self.label_ligand_radius_2.setText(_translate("REvoDesignPyMOL_UI", "
        self.spinBox_maximal_mutant_num.setStatusTip(
            _translate(
                "REvoDesignPyMOL_UI",
                "Maximum number of mutations for each variant."))
        self.label_chainid_14.setText(_translate("REvoDesignPyMOL_UI", "
