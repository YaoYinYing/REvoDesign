...
from REvoDesign.UI.cluster_tab import retranslate_cluster_tab, setup_cluster_tab
...
class Ui_REvoDesignPyMOL_UI:
    def setupUi(self, REvoDesignPyMOL_UI):
        ...
        setup_cluster_tab(self, self.tab_cluster)
    ...
    def retranslateUi(self, REvoDesignPyMOL_UI):
        ...
        retranslate_cluster_tab(self, _translate)
