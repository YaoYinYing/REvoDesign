...
class Ui_Dialog:
    def setupUi(self, Dialog):
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.lineEdit_proxy_url.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.lineEdit_mirror_url.sizePolicy().hasHeightForWidth()
        )
        ...
        self.checkBox_user_cache_dir = QtWidgets.QCheckBox(
            self.horizontalLayoutWidget
        )
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.checkBox_user_cache_dir.sizePolicy().hasHeightForWidth()
        )
        ...
        self.lineEdit_customized_cache_dir = QtWidgets.QLineEdit(
            self.horizontalLayoutWidget
        )
        self.lineEdit_customized_cache_dir.setEnabled(False)
        self.lineEdit_customized_cache_dir.setObjectName(
            "lineEdit_customized_cache_dir"
        )
        self.horizontalLayout_11.addWidget(self.lineEdit_customized_cache_dir)
        self.pushButton_open_cache_dir = QtWidgets.QPushButton(
            self.horizontalLayoutWidget
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.pushButton_open_cache_dir.sizePolicy().hasHeightForWidth()
        )
        self.pushButton_open_cache_dir.setSizePolicy(sizePolicy)
        self.pushButton_open_cache_dir.setObjectName(
            "pushButton_open_cache_dir"
        )
        self.horizontalLayout_11.addWidget(self.pushButton_open_cache_dir)
        self.pushButton_set_cache_dir = QtWidgets.QPushButton(
            self.horizontalLayoutWidget
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.pushButton_set_cache_dir.sizePolicy().hasHeightForWidth()
        )
        ...
        self.radioButton_extra_customized.setObjectName(
        ...
        self.radioButton_extra_everything.setObjectName(
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.listView_extras.sizePolicy().hasHeightForWidth()
        )
        ...
        self.radioButton_from_local_file.toggled["bool"].connect(
            self.checkBox_specified_version.setDisabled
        )  # type: ignore
        self.radioButton_from_local_file.toggled["bool"].connect(
            self.checkBox_specified_commit.setDisabled
        )  # type: ignore
        ...
        self.checkBox_user_cache_dir.toggled["bool"].connect(
            self.lineEdit_customized_cache_dir.setEnabled
        )  # type: ignore
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit_customized_cache_dir.setToolTip(
            _translate("Dialog", "Cache file on this dir")
        )
        self.pushButton_open_cache_dir.setToolTip(
            _translate("Dialog", "Open a dir as cache directory.")
        )
        self.pushButton_open_cache_dir.setText(_translate("Dialog", "..."))
        self.pushButton_set_cache_dir.setToolTip(
            _translate("Dialog", "Apply this directory for cache.")
        )
        ...
        self.radioButton_extra_none.setToolTip(
            _translate("Dialog", "Default setting with no extra dependencies.")
        )
        self.radioButton_extra_none.setText(_translate("Dialog", "None"))
        self.radioButton_extra_customized.setToolTip(
            _translate("Dialog", "Customized extras picked from right panel.")
        )
        self.radioButton_extra_customized.setText(
            _translate("Dialog", "Customized")
        )
        self.radioButton_extra_everything.setToolTip(
            _translate("Dialog", "Install with all extras except unit tests")
        )
        self.radioButton_extra_everything.setText(
            _translate("Dialog", "Everything")
        )
