...
get_designable_chain_ids = lambda: list(ConfigBus().get_value("designable_sequences", dict, reject_none=True,  cfg='runtime').keys())
...
get_all_chain_ids = lambda: list(ConfigBus().get_value("designable_sequences", dict, reject_none=True, cfg='runtime').keys())
