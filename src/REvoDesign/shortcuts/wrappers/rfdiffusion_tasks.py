...
def _visualize_substrate_potentials(**kwargs):
    ...
    sp_visualizer.plot_potential_field(grid_size=grid_size, margin=margin, save_to=save_to)
...
wrapped_visualize_substrate_potentials = registry.register(
    "visualize_substrate_potentials", _visualize_substrate_potentials
)

# Register the General RFdiffusion Task
wrapped_general_rfdiffusion_task = registry.register(
    "general_rfdiffusion_task", _run_general_rfdiffusion_task, use_thread=True, use_progressbar=True
)
