...
if __name__ == "__main__":
  ...
  assert instance != None and instance != ''
  ...
  for model_name in model_names:
    ...
    # plot in segments
    plot_in_segment(df=df_this_model_t, sequence=sequence, n=100, label=f'{instance}_{model_name}', save_dir=save_dir,
