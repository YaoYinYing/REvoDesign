...
class CitableModuleAbstract(ABC):
    ...
    def get_citable_class(cls, func: Callable) -> type["CitableModuleAbstract"]:
        ...
        Args:
            func (Callable): The function from which to get the citable class.
        Returns:
        ...
        class AnonymousCitableModule(cls):
            ...
            __bibtex__ = func.__bibtex__

        AnonymousCitableModule.__doc__ = f"""Citable module for function {
            func.__name__}, auto generated by CitableModuleAbstract."""  # type: ignore[assignment]

        return AnonymousCitableModule
