...
SCOPED_QT_REPLACEMENTS = {
    "QtCore.Qt.AlignmentFlag.": "QtCompat.",
    "QtCore.Qt.InputMethodHint.": "QtCompat.",
    "QtCore.Qt.TextFormat.": "QtCompat.",
    "QtCore.Qt.Orientation.": "QtCompat.",
}
SCOPED_QTWIDGETS_REPLACEMENTS = {
    "QtWidgets.QSizePolicy.Policy.": "QtWidgets.QSizePolicy.",
    "QtWidgets.QTabWidget.TabShape.": "QtWidgets.QTabWidget.",
    "QtWidgets.QComboBox.SizeAdjustPolicy.": "QtWidgets.QComboBox.",
    "QtWidgets.QFrame.Shape.": "QtWidgets.QFrame.",
    "QtWidgets.QFrame.Shadow.": "QtWidgets.QFrame.",
    "QtWidgets.QLCDNumber.SegmentStyle.": "QtWidgets.QLCDNumber.",
    "QtWidgets.QFormLayout.ItemRole.": "QtWidgets.QFormLayout.",
    "QtWidgets.QLayout.SizeConstraint.": "QtWidgets.QLayout.",
}
FORBIDDEN_IMPORT_RE = re.compile(r"\b(?:from|import)\s+(?:PyQt5|PyQt6|PySide2|PySide6)\b")
GENERATED_HEADER_RE = re.compile(
    r"^# Form implementation generated from reading ui file '([^']+)'\n"
    r"#\n"
    r"# Created by: .*\n"
    r"#\n"
    r"# WARNING: Any manual changes made to this file will be lost when .*\n"
    r"# run again\.  Do not edit this file unless you know what you are doing\.\n\n\n",
    re.MULTILINE,
)
NORMALIZED_HEADER_TEMPLATE = (
    "# -*- coding: utf-8 -*-\n\n"
    "# Form implementation generated from reading ui file '{ui_path}'\n"
    "#\n"
...
def _replace_qtcore_qt_constants(text: str) -> str:
    ...
    for old_prefix, new_prefix in SCOPED_QT_REPLACEMENTS.items():
        text = text.replace(old_prefix, new_prefix)
    for old_prefix, new_prefix in SCOPED_QTWIDGETS_REPLACEMENTS.items():
        text = text.replace(old_prefix, new_prefix)
    return text
...
def _normalize_generated_header(text: str) -> str:
    match = GENERATED_HEADER_RE.match(text)
    if not match:
        return text
    header = NORMALIZED_HEADER_TEMPLATE.format(ui_path=match.group(1))
    return GENERATED_HEADER_RE.sub(header, text, count=1)
...
def rewrite_generated_qt_source(text: str) -> str:
    ...
    text = _normalize_generated_header(text)
    return text
