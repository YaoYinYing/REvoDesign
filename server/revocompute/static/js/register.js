...
(function () {
  ...
  function loadCaptcha() {
    ...
    fetch("/compute/api/auth/captcha")
  ...
  form.addEventListener("submit", function (e) {
    ...
    var payload = {
      ...
      pi_name: document.getElementById("piName").value.trim(),
      terms_agreed: document.getElementById("termsAgreed").checked,
      captcha_token: captchaToken.value,
      captcha_answer: captchaAnswer.value,
    };

    fetch("/compute/api/auth/register", {
      method: "POST",
  ...
  if (resendBtn) {
    resendBtn.addEventListener("click", function () {
      ...
      fetch("/compute/api/auth/resend-verification", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
