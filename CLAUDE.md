...
- **Doc-only PRs**: When a PR only touches files under `docs/`, `mkdocs.yml`, or `.github/workflows/docs.yml`, append `[skip ci]` to the final commit message. CI testing is unnecessary for documentation-only changes.
