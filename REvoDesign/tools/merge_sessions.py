...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Merge multiple PyMOL sessions.")
    parser.add_argument("sessions", nargs="+", help="List of PyMOL session paths to merge.")
    parser.add_argument("-s", "--save", metavar="output_path", help="Path to save the merged session.")
