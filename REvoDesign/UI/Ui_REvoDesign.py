...
# Form implementation generated from reading ui file 'REvoDesign/UI/REvoDesign.ui'
#
...
class Ui_REvoDesignPyMOL_UI(object):
    def setupUi(self, REvoDesignPyMOL_UI):
        ...
        REvoDesignPyMOL_UI.resize(660, 560)
        ...
        self.checkBox_reverse_mutant_effect = QtWidgets.QCheckBox(self.verticalLayoutWidget_4)
        self.checkBox_reverse_mutant_effect.setObjectName("checkBox_reverse_mutant_effect")
        self.verticalLayout_7.addWidget(self.checkBox_reverse_mutant_effect)
        ...
        self.checkBox_reverse_mutant_effect_2 = QtWidgets.QCheckBox(self.verticalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkBox_reverse_mutant_effect_2.sizePolicy().hasHeightForWidth())
        self.checkBox_reverse_mutant_effect_2.setSizePolicy(sizePolicy)
        self.checkBox_reverse_mutant_effect_2.setObjectName("checkBox_reverse_mutant_effect_2")
        self.horizontalLayout_13.addWidget(self.checkBox_reverse_mutant_effect_2)
        ...
        self.checkBox_reverse_mutant_effect_3 = QtWidgets.QCheckBox(self.verticalLayoutWidget_13)
        self.checkBox_reverse_mutant_effect_3.setObjectName("checkBox_reverse_mutant_effect_3")
        self.verticalLayout_9.addWidget(self.checkBox_reverse_mutant_effect_3)
        ...
        self.verticalLayoutWidget_6.setGeometry(QtCore.QRect(10, 30, 261, 231))
        ...
        self.checkBox_interact_ignore_wt = QtWidgets.QCheckBox(self.verticalLayoutWidget_6)
        self.checkBox_interact_ignore_wt.setObjectName("checkBox_interact_ignore_wt")
        self.horizontalLayout_44.addWidget(self.checkBox_interact_ignore_wt)
        ...
        self.horizontalLayout_44.addWidget(self.label_chainid_13)
        ...
        self.horizontalLayout_44.addWidget(self.comboBox_external_scorer)
        ...
        self.horizontalLayout_46.addWidget(self.label_chainid_10)
        ...
        self.horizontalLayout_46.addWidget(self.lineEdit_current_pair)
        ...
        self.horizontalLayout_46.addWidget(self.label_chainid_12)
        ...
        self.horizontalLayout_46.addWidget(self.lineEdit_current_pair_score)
        ...
        self.horizontalLayout_45.addWidget(self.label_chainid_9)
        ...
        self.horizontalLayout_45.addWidget(self.lineEdit_current_pair_wt_score)
        ...
        self.horizontalLayout_45.addWidget(self.label_chainid_8)
        ...
        self.horizontalLayout_45.addWidget(self.lineEdit_current_pair_mut_score)
        ...
        self.comboBox_cmap = QtWidgets.QComboBox(self.groupBox_8)
        self.comboBox_cmap.setGeometry(QtCore.QRect(10, 30, 120, 21))
        ...
        self.menuREvoDesign = QtWidgets.QMenu(self.menubar)
        self.menuREvoDesign.setObjectName("menuREvoDesign")
        self.menuExperiment = QtWidgets.QMenu(self.menuREvoDesign)
        self.menuExperiment.setObjectName("menuExperiment")
        self.menuLanguage = QtWidgets.QMenu(self.menuREvoDesign)
        ...
        self.menuREvoDesign.addAction(self.actionCheck_PyMOL_session)
        self.menuREvoDesign.addAction(self.actionSet_Working_Directory)
        self.menuREvoDesign.addSeparator()
        self.menuREvoDesign.addAction(self.actionReconfigure)
        self.menuREvoDesign.addAction(self.actionSave_Configurations)
        self.menuREvoDesign.addAction(self.actionLoad_Demo)
        self.menuREvoDesign.addAction(self.menuExperiment.menuAction())
        self.menuREvoDesign.addSeparator()
        self.menuREvoDesign.addAction(self.actionReinitialize)
        self.menuREvoDesign.addSeparator()
        self.menuREvoDesign.addAction(self.menuLanguage.menuAction())
        ...
        self.menubar.addAction(self.menuREvoDesign.menuAction())
        self.menubar.addAction(self.menuAbout.menuAction())

        self.retranslateUi(REvoDesignPyMOL_UI)
        self.tabWidget.setCurrentIndex(0)
        self.stackedWidget.setCurrentIndex(1)
        self.checkBox_reverse_mutant_effect.toggled['bool'].connect(self.checkBox_reverse_mutant_effect_2.toggle) # type: ignore
    ...
    def retranslateUi(self, REvoDesignPyMOL_UI):
        ...
        self.comboBox_ligand_sel.setStatusTip(_translate("REvoDesignPyMOL_UI", "Substrate/Product molecule. Use PyMOL selection syntax(eg. (LIG or PRD))"))
        ...
        self.comboBox_cofactor_sel.setStatusTip(_translate("REvoDesignPyMOL_UI", "Co-factor or co-enzyme, HEM/FAD/NAD, etc. Use PyMOL selection syntax (eg. (HEM or FAD))"))
        ...
        self.checkBox_reverse_mutant_effect.setText(_translate("REvoDesignPyMOL_UI", "Reverse"))
        ...
        self.checkBox_reverse_mutant_effect_2.setStatusTip(_translate("REvoDesignPyMOL_UI", "Lower scores will be favored in certain scoring methods, such as ddG scoring."))
        self.checkBox_reverse_mutant_effect_2.setText(_translate("REvoDesignPyMOL_UI", "Reversed"))
        ...
        self.checkBox_reverse_mutant_effect_3.setStatusTip(_translate("REvoDesignPyMOL_UI", "Lower scores will be favored in certain scoring methods, such as ddG scoring."))
        self.checkBox_reverse_mutant_effect_3.setText(_translate("REvoDesignPyMOL_UI", "Reversed"))
        ...
        self.checkBox_interact_ignore_wt.setStatusTip(_translate("REvoDesignPyMOL_UI", "Ignore WT-to-WT mutagenesis"))
        self.checkBox_interact_ignore_wt.setText(_translate("REvoDesignPyMOL_UI", "Ignore WT"))
